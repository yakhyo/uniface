...
#
# Face mesh edge lists vendored from PINTO0309/facemesh_onnx_tensorrt (Apache-2.0):
#   https://github.com/PINTO0309/facemesh_onnx_tensorrt
# Original 468-point topology from Google MediaPipe (Apache-2.0):
#   https://github.com/google-ai-edge/mediapipe
#
# Edges index into the 468-point mesh returned by `uniface.landmark.FaceMesh`.
# PARTIAL is a sparse contour set (124 edges); FULL is the dense tessellation
# (2556 edges) and is far heavier to draw.
...
FACEMESH_TESSELATION_FULL: list[list[int]] = [
